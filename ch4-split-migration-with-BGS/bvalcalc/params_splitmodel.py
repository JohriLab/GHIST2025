...
Nanc = 9826 / x # Ancestral population size [1]
r = 0.5e-8 * x # Recombination (crossover) rate per bp, per generation (sex-averaged) [2]
u = 1e-8 * x # Mutation rate (all types) per bp, per generation [1]
